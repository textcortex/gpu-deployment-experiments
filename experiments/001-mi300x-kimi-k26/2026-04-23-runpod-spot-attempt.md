...
The immediate blocker is RunPod MI300X spot capacity in `EU-RO-1`, not only the Kimi K2.6 4x configuration. Even an idle 1x MI300X spot pod could not be allocated.
